...
const commentUrl = 'http://localhost:3002/message-board/comment';
...
export default function AddCommentModal(props: Props) {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        fetch(`${commentUrl}/${props.userid}/${props.postid}`, {
            method: 'POST',
            body: JSON.stringify({
                content: data.get('comment-content'),
            }),
            headers: {
