...
function CommentFlyout(props: Props) {
    return (
        <Drawer anchor={props.anchor} open={props.open} onClose={props.onClose}>
            <Stack padding={'24px 24px'} width={'900px'} position={'fixed'} sx={{ backgroundColor: 'white' }}>
                <Box>
            ...
            <Box padding={'24px 24px'} gap={'24px'} width={'900px'} marginTop={'275px'}>
                <Box role="presentation" padding={'16px 16px'} gap={'8px'}>
